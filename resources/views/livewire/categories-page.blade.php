        ...
        <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div class="p-4 md:p-5">
                    <div class="flex items-center">
                        <div class="flex items-center flex-grow">
                            <img class="h-[5rem] w-[5rem] flex-shrink-0" src="https://cdn.bajajelectronics.com/product/b002c02c-c379-49f8-b2a6-bd2e56d0e23a" alt="Image Description">
            ...
            <a class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">
                <div class="p-4 md:p-5">
                    <div class="flex items-center">
                        <div class="flex items-center flex-grow">
                            <img class="h-[5rem] w-[5rem] flex-shrink-0" src="https://static.toiimg.com/thumb/msid-86223197,width-400,resizemode-4/86223197.jpg" alt="Image Description">
                            <div class="ms-3 flex-grow self-center">
                                <h3 class="group-hover:text-blue-600 text-lg sm:text-xl md:text-2xl font-semibold text-gray-800 dark:group-hover:text-gray-400 dark:text-gray-200 break-words hyphens-auto">
            ...
            <a class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">
                <div class="p-4 md:p-5">
                    <div class="flex items-center">
                        <div class="flex items-center flex-grow">
                            <img class="h-[5rem] w-[5rem] flex-shrink-0" src="https://store.storeimages.cdn-apple.com/4668/as-images.apple.com/is/watch-card-40-ultra2-202309_GEO_IN_FMT_WHH?wid=508&hei=472&fmt=p-jpg&qlt=95&.v=1693611639854" alt="Image Description">
                            <div class="ms-3 flex-grow self-center">
                                <h3 class="group-hover:text-blue-600 text-lg sm:text-xl md:text-2xl font-semibold text-gray-800 dark:group-hover:text-gray-400 dark:text-gray-200 break-words hyphens-auto">
                                    Защита бетона
                                </h3>
