        ...
        <div class="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
            <div class="flex flex-wrap -mx-4">
                ...
                <div class="w-full px-4 md:w-1/2 ">
                    <div class="lg:pl-20">
                        <div class="mb-8 ">
                            <h2 class="max-w-xl mb-6 text-2xl font-bold dark:text-gray-400 md:text-4xl">СК-ПУР  полиуретановая грунтовка для металла в Екатеринбурге</h2>
                            <p class="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                                <span>1500.99 &#8381;</span>
                                <span class="text-base font-normal text-gray-500 line-through dark:text-gray-400">1800.99 &#8381;</span>
                            </p>
                            <p class="max-w-md text-gray-700 dark:text-gray-400">
                                Применяется в качестве грунтовочного покрытия в комплексных системах антикоррозионной защиты металлических конструкций. Покрытие грунтовки эксплуатируется совместно с покрытиями эмалей или грунт-эмалей на полиуретановой основе.
                            </p>
                        </div>
                        <div class="w-32 mb-8 ">
