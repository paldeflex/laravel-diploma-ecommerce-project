    ...
    <nav class="max-w-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8" aria-label="Глобальная навигация">
        <div class="relative md:flex md:items-center md:justify-between">
            <div class="flex items-center justify-between">
                ...
                <div class="md:hidden">
                    <button type="button"
                            class="hs-collapse-toggle flex justify-center items-center w-9 h-9 text-sm font-semibold rounded-lg border border-gray-700 text-white hover:bg-gray-800 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            data-hs-collapse="#navbar-collapse-with-animation"
                            aria-controls="navbar-collapse-with-animation" aria-label="Переключить навигацию">
                        <svg class="hs-collapse-open:hidden flex-shrink-0 w-4 h-4 text-white"
            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div
                    ...
                    <div
                        class="flex flex-col gap-x-0 mt-5 divide-y divide-dashed divide-gray-700 md:flex-row md:items-center md:justify-end md:gap-x-7 md:mt-0 md:ps-7 md:divide-y-0 md:divide-solid">

                        <a wire:navigate
                           class="font-medium {{ request()->is('/') ? 'text-blue-400' : 'text-gray-400' }} py-3 md:py-6 hover:text-gray-300"
                           href="/" aria-current="page">Главная</a>

                        <a wire:navigate
                           class="font-medium {{ request()->is('categories') ? 'text-blue-400' : 'text-gray-400' }} hover:text-gray-300 py-3 md:py-6"
                           href="/categories">
                            Категории
                        </a>

                        <a wire:navigate
                           class="font-medium {{ request()->is('products') ? 'text-blue-400' : 'text-gray-400' }} hover:text-gray-300 py-3 md:py-6"
                           href="/products">
                            Продукция
                        </a>

                        <a wire:navigate
                           class="font-medium flex items-center {{ request()->is('cart') ? 'text-blue-400' : 'text-gray-400' }} hover:text-gray-300 py-3 md:py-6"
                           href="/cart">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                 stroke="currentColor" class="flex-shrink-0 w-5 h-5 mr-1 text-white">
                        ...
                        @guest
                            <div class="pt-3 md:pt-0">
                                <a wire:navigate
                                   class="py-2.5 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700"
                                   href="/login">
