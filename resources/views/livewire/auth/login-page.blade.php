            ...
            <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
                <div class="p-4 sm:p-7">
                    <div class="text-center">
                        <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Войти</h1>
                    ...
                    <form>
                        <div class="grid gap-y-4">
                            <!-- Группа формы -->
                            <div>
                                <label for="email" class="block text-sm mb-2 dark:text-white">Электронная почта</label>
                                <div class="relative">
                                ...
                                <p class="hidden text-xs text-red-600 mt-2" id="email-error">Пожалуйста, укажите действующий адрес электронной почты, чтобы мы могли с вами связаться</p>
                            </div>
                            <!-- Конец группы формы -->
                            ...
                            <div>
                                <div class="flex justify-between items-center">
                                    ...
                                    <a wire:navigate class="text-sm text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/forgot">Забыли пароль?</a>
                                </div>
                                <div class="relative">
                                ...
                                <p class="hidden text-xs text-red-600 mt-2" id="password-error">Требуется не менее 8 символов</p>
                            </div>
                            <!-- Конец группы формы -->
